define(['exports', './lib/tslib/index'], function (exports, index$1) { 'use strict';
            ...
            release: function () {
                ...
                if (i >= 0) {
                    onrelease.forEach(function (_a) {
                        var _b = index$1.__read(_a, 2), callback = _b[0], context = _b[1];
    ...
    function completeWork() {
        ...
        if (--working === 0) {
            ...
            while (ondoneCallbacks.length && currentWork === -1) {
                var _a = index$1.__read(ondoneCallbacks.shift(), 2), callback = _a[0], context = _a[1];
                callback.call(context || null);
            }
        }
    }
