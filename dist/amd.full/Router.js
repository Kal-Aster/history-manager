define(['exports', './lib/tslib/index', './PathGenerator', './URLManager', './HistoryManager', './NavigationLock', './lib/query-string/index'], function (exports, index$1, PathGenerator, URLManager, HistoryManager, NavigationLock, qs) { 'use strict';
    ...
    function getLocation(href) {
        ...
        return {
            ...
            addQueryParam: function (param, value) {
                ...
                var newQuery = index$1.__assign(index$1.__assign({}, this.parsedQuery), (_d = {}, _d[param] = value, _d));
                cachedQuery = null;
    ...
    function go(path_index, options) {
        ...
        options = index$1.__assign({}, options);
        return new Promise(function (promiseResolve, promiseReject) {
            var goingEvent = new CustomEvent("router:going", {
                detail: index$1.__assign({ direction: path_index }, options),
                cancelable: true
            });
